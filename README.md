...
<a href="https://www.codecogs.com/eqnedit.php?latex=d&space;f(x,p_x,t)&space;=&space;\frac{\partial&space;f}{\partial&space;x}&space;\cdot&space;dx&space;&plus;&space;\frac{\partial&space;f}{\partial&space;p_x}&space;\cdot&space;dp_x&space;&plus;&space;\frac{\partial&space;f}{\partial&space;t}&space;dt" target="_blank"><img src="https://latex.codecogs.com/gif.latex?d&space;f(x,p_x,t)&space;=&space;\frac{\partial&space;f}{\partial&space;x}&space;\cdot&space;dx&space;&plus;&space;\frac{\partial&space;f}{\partial&space;p_x}&space;\cdot&space;dp_x&space;&plus;&space;\frac{\partial&space;f}{\partial&space;t}&space;dt" title="d f(x,p_x,t) = \frac{\partial f}{\partial x} \cdot dx + \frac{\partial f}{\partial p_x} \cdot dp_x + \frac{\partial f}{\partial t} dt" /></a>

<a href="https://www.codecogs.com/eqnedit.php?latex==&space;[\frac{\partial&space;f}{\partial&space;x}&space;\cdot&space;\frac{\partial&space;H}{\partial&space;p_x}&space;-&space;\frac{\partial&space;f}{\partial&space;p_x}&space;\cdot&space;\frac{\partial&space;H}{\partial&space;x}&space;&plus;&space;\frac{\partial&space;f}{\partial&space;t}]&space;dt" target="_blank"><img src="https://latex.codecogs.com/gif.latex?=&space;[\frac{\partial&space;f}{\partial&space;x}&space;\cdot&space;\frac{\partial&space;H}{\partial&space;p_x}&space;-&space;\frac{\partial&space;f}{\partial&space;p_x}&space;\cdot&space;\frac{\partial&space;H}{\partial&space;x}&space;&plus;&space;\frac{\partial&space;f}{\partial&space;t}]&space;dt" title="= [\frac{\partial f}{\partial x} \cdot \frac{\partial H}{\partial p_x} - \frac{\partial f}{\partial p_x} \cdot \frac{\partial H}{\partial x} + \frac{\partial f}{\partial t}] dt" /></a>
